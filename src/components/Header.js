...
const Header = () => {
  return (
    <div className="sm:pl-10 sm:pr-24 px-5 flex flex-col pb-5">
      <div
      ...
      >
        <div className="flex flex-row gap-5 items-center justify-center">
          ...
          <h1 className="text-2xl font-righteous font-thin">XPLAY</h1>
        </div>
        ...
        <div className="flex flex-row gap-5 basis-1/2">
          {/* searchbar */}
          <div className="sm:bg-lightDark py-2 px-3 rounded-xl w-10 sm:w-full flex items-center">
            <FontAwesomeIcon icon={faMagnifyingGlass} />
            <input
              type="text"
              placeholder="Search"
              className="rounded-full bg-transparent text-xs pl-2 max-sm:placeholder-transparent placeholder-opacity-0 
                        sm:placeholder-opacity-100 text-text w-full"
            />
          </div>
          {/* end searchbar */}
